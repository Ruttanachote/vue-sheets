				...
				<div class="container">
					<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mt-3 ">
						...
						<div class="btn-toolbar mb-2 mb-md-0">
							...
							<a 	href="https://docs.google.com/spreadsheets/d/17K95YwoL3vM-PVPsR91_j7jjzgyMFIHL3Ju-Eb2raoQ/edit?usp=sharing" 
	...
	export default {
		...
		methods: {
			async addRow() {
				...
				const doc = new GoogleSpreadsheet('17K95YwoL3vM-PVPsR91_j7jjzgyMFIHL3Ju-Eb2raoQ');
